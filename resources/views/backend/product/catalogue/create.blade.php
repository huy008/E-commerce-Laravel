                              ...
                              <div class="row mb15">
                                   <div class="col-lg-12">
                                        <div class="form-row">
                                             ...
                                             <input type="text" name="name" value="{{ old('name', ($productCatalogue->name) ?? '' ) }}" class="form-control" placeholder="" autocomplete="off" {{ (isset($disabled)) ? 'disabled' : '' }}>
                                        </div>
                                   </div>
                              </div>
                              <div class="row mb15">
                                   <div class="col-lg-12">
                                        <div class="form-row">
                                             ...
                                             <textarea name="description" class="ck-editor" id="ckDescription" data-height="100">{{ old('description', ($productCatalogue->description) ?? '') }}</textarea>
                                        </div>
                                   </div>
                              </div>
                              <div class="row mb15">
                                   <div class="col-lg-12">
                                        <div class="form-row">
                                             ...
                                             <textarea name="content" class="form-control ck-editor" placeholder="" autocomplete="off" id="ckContent" data-height="500">{{ old('content', ($productCatalogue->content) ?? '' ) }}</textarea>
                                        </div>
                                   </div>
                                        ...
                                        <div class="row mb15">
                                             <div class="col-lg-12">
                                                  <div class="form-row">
                                                       ...
                                                       <input type="text" name="meta_title" value="{{ old('meta_title', ($productCatalogue->meta_title) ?? '' ) }}" class="form-control" placeholder="" autocomplete="off" {{ (isset($disabled)) ? 'disabled' : '' }}>
                                                  </div>
                                             </div>
                                        </div>
                                        <div class="row mb15">
                                             <div class="col-lg-12">
                                                  <div class="form-row">
                                                       ...
                                                       <input type="text" name="meta_keyword" value="{{ old('meta_keyword', ($productCatalogue->meta_keyword) ?? '' ) }}" class="form-control" placeholder="" autocomplete="off" {{ (isset($disabled)) ? 'disabled' : '' }}>
                                                  </div>
                                             </div>
                                        </div>
                                        <div class="row mb15">
                                             <div class="col-lg-12">
                                                  <div class="form-row">
                                                       ...
                                                       <textarea name="meta_description" class="form-control" placeholder="" autocomplete="off" {{ (isset($disabled)) ? 'disabled' : '' }}>{{ old('meta_description', ($productCatalogue->meta_description) ?? '') }}</textarea>
                                                  </div>
                                             </div>
                                        </div>
                                        <div class="row mb15">
                                             <div class="col-lg-12">
                                                  <div class="form-row">
                                                       ...
                                                       <div class="input-wrapper">
                                                            <input type="text" name="canonical" value="{{ old('canonical', ($productCatalogue->canonical) ?? '' ) }}" class="form-control seo-canonical" placeholder="" autocomplete="off" {{ (isset($disabled)) ? 'disabled' : '' }}>
                                   ...
                                   <div class="col-lg-12">
                                        <div class="form-row">
                                             ...
                                             <select name="parentid" class="form-control ">
                                                  ...
                                                  <option {{
                                                   $key==old('parentid',(isset($productCatalogue->parentid)) ? $productCatalogue->parentid : '') ? ' selected="selected"' : ''
