                         ...
                         <div class="ibox">
                              ...
                              <div class="ibox-content">
                                   <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                             <div class="form-row">
                                                  <label for="" class="control-label text-right">Ho ten</label>
                                                       ...
                                                       <option {{ $key == old('user_catalogue_id',   
                                                              (isset($user->user_catalogue_id)) ?
                                                                  $user->user_catalogue_id : '')
                                                                   ? 'selected' : '' }} value="{{ $key }}">{{ $item }}</option>
                                                       @endforeach
                                                  </select>
                                             </div>
                                        </div>
                              ...
                              <div class="ibox-content">
                                   ...
                                   <div class="row">
                                        <div class="col-lg-12">
                                             <div class="form-row">
                                                  <label for="" class="control-label text-right">Anh</label>
                         ...
                         <div class="ibox">
                              ...
                              <div class="ibox-content">
                                   <div class="row">
                                        <div class="col-lg-6">
                                             <div class="form-row">
                                                  <label for="" class="control-label text-right">Thanh pho</label>
                                                  <select name="province_id" class="form-control setupSelect2 province location" data-target="districts">
                                                       ...
                                                       <option @if(old('province_id')==$province->code)
                                                            selected @endif value="{{$province->code}}">
                                                            {{$province->name}}
                                                       </option>
                                        ...
                                        <div class="col-lg-6">
                                             <div class="form-row">
                                                  <label for="" class="control-label text-right">Quan/Huyen</label>
                                   ...
                                   <div class="row">
                                        <div class="col-lg-6">
                                             <div class="form-row">
                                                  <label for="" class="control-label text-right">Phuong/Xa</label>
                              ...
                              <div class="ibox-content">
                                   <div class="row">
                                        <div class="col-lg-6">
                                             <div class="form-row">
                                                  <label for="" class="control-label text-right">So dien thoai</label>
                                                  <input type="text" name="phone" value="{{old('phone',($user->phone) ?? '')}}" class="form-control" placeholder="" autocomplete="off">
                                             </div>
                                        </div>
                                        <div class="col-lg-6">
                                             <div class="form-row">
                                                  <label for="" class="control-label text-right">Ghi chu</label>
