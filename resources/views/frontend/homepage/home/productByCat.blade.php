                  ...
                  <div class="uk-flex uk-flex-middle">
                      ...
                      <div class="category-children">
                          <ul class="uk-list uk-clearfix uk-flex uk-flex-middle">
                              ...
                              <li class=""><a href="{{route('frontend.catalogue.index',['id'=> $cat->id])}}" title="">{{$cat->product_catalogue_language[0]->name}}</a></li>
                              @endforeach
                          </ul>
                      </div>
                  </div>
                      ...
                      <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                              <div class="category-item bg-<?php echo rand(1, 7) ?>">
                                  <a href="" class="image img-scaledown img-zoomin"><img src="{{$cat->image}}" alt=""></a>
      ...
      <div class="panel-body">
          <div class="uk-grid uk-grid-medium ">
              ...
              <div class="product-item product">
                  ...
                  <a href="" class="image img-cover"><img src="{{$product->image}}" alt=""></a>
                  <div class="info">
                      <!-- <div class="category-title"><a href="" title=""></a></div>
        <h3 class="title"><a href="" title=""></a></h3> -->
                  ...
                  <div class="tools">
                      <a href="" title=""><img src="http://127.0.0.1:8000/frontend/resources/img/trend.svg" alt=""></a>
                      <a href="" title=""><img src="http://127.0.0.1:8000/frontend/resources/img/wishlist.svg" alt=""></a>
                      <a href="" title=""><img src="http://127.0.0.1:8000/frontend/resources/img/compare.svg" alt=""></a>
                      <a href="#popup" data-uk-modal title=""><img src="http://127.0.0.1:8000/frontend/resources/img/view.svg" alt=""></a>
                  </div>
              </div>
              @endforeach
          </div>
