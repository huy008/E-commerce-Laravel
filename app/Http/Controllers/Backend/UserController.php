...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        $config = [
            'js' => [
                ...
                'http://127.0.0.1:8000/backend/library/finder.js',        'http://127.0.0.1:8000/backend/library/location.js'
            ],
            'css' => ['https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css'],
        ];
    ...
    public function edit($id)
    {
        ...
        $config = [
            'js' => [
                'https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js',                  'http://127.0.0.1:8000/backend/library/location.js',
                'http://127.0.0.1:8000/backend/plugins/ckfinder_2/ckfinder.js',
