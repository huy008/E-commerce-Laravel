               ...
               <div class="col-lg-9">
                    <div class="ibox">
                         ...
                         <div class="ibox">
                              ...
                              <div class="ibox-content">
                                   @php
                                   $album = (!empty(${module}->album)) ? json_decode(${module}->album) : [];
                                   ...
                                   <div class="col-lg-12">
                                        <div class="form-row">
                                             ...
                                             <select name="{module}_catalogue_id" class="form-control setupSelect2 ">
                                                  ...
                                                  <option {{$key==old('{module}_catalogue_id',((isset(${module}->{module}_catalogue_id)) ? ${module}->{module}_catalogue_id : '') ? 'selected' : '' )}} value="{{$key}}">{{$value}}</option>
                                                  @endforeach
                                             </select>
                                        </div>
                                   </div>
