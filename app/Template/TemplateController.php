...
class {ModuleTemplate}Controller extends Controller
{
     ...
     public function create()
     {
          ...
          $template = 'backend.{moduleView}.{moduleView}.create';
     ...
     {
          ${moduleTemplate} = $this->{moduleTemplate}Repository->get{moduleTemplate}ById($id, $this->currentLanguage());
          $config = [
               'js' => [
                    '/backend/plugins/ckfinder_2/ckfinder.js',
                    '/backend/plugins/ckeditor/ckeditor.js',
     ...
     public function delete($id)
     {
          ...
          $template = 'backend.{moduleView}.{moduleView}.delete';
